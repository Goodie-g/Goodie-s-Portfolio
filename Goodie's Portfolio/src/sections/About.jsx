...
function About() {
    return (
        <section id="About" className="relative px-6 md:px-12 lg:px-16 py-20 md:py-24 overflow-hidden">

            {/* Ambient glow */}
            <div
                aria-hidden="true"
                className="pointer-events-none absolute -left-24 top-1/2 h-80 w-80 -translate-y-1/2 rounded-full bg-[#58c4dc]/10 blur-[120px]"
            />
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-center gap-12 md:gap-16">
                ...
                <div className="max-w-xl text-center md:text-left">
                    <h2 className="tracking-tight">About me:</h2>
